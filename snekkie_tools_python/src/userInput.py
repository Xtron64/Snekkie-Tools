            ...
            while True:  # Starts a loop
                ...
                if case:  # Checks if the case parameter has a value
                    if case == low_kw:  # If the case is meant to be lowercase:
                        return answer.lower()  # Then it returns the user's answer in lowercase
                    elif case == up_kw:  # If the case is meant to be uppercase:
                        return answer.upper()  # Then it returns the user's answer in uppercase
                    elif case == title_kw:  # If the case is meant to be titlecase:
                        return answer.title()  # Then it returns the user's answer in titlecase
                    else:  # If case has an invalid value:
                        return answer # Return the user's answer exactly how the user inputted it
